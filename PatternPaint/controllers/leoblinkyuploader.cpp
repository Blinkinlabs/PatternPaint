...
//        }
        ...
        QByteArray ledData = pattern.getData();
...
bool LeoBlinkyUploader::upgradeFirmware(BlinkyController &controller)
{
    Q_UNUSED(controller);

    errorString = "Firmware update not currently supported for LeoBlinky!";
    return false;
}

bool LeoBlinkyUploader::upgradeFirmware(int)
{
    errorString = "Firmware update not currently supported for LeoBlinky!";
    return false;
}
