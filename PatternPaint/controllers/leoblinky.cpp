...
void LeoBlinky::handleSerialError(QSerialPort::SerialPortError error)
{
...
void LeoBlinky::handleSerialReadData()
{
...
bool LeoBlinky::getUploader(QPointer<BlinkyUploader> &uploader)
{
    if (!isConnected())
        return false;
