        ...
        for (int i = 0; i < response.length(); i++) {
            if (expectedResponseMask.at(i) != 0
                ...
                errorString = QString()
                        ...
                        .append(" expected: %1").arg((quint8)expectedResponse.at(i),2,16)
                        .append(" received: %1").arg((quint8)response.at(i),2,16)
                        .append(" mask: %1").arg((quint8)expectedResponseMask.at(i),2,16);
