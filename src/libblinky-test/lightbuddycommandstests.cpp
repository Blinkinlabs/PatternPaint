...
void LightBuddyCommandsTests::fileNewTest()
{
    ...
    expectedData.append(ByteArrayCommands::uint32ToByteArrayBig(size));
...
void LightBuddyCommandsTests::writePageTest()
{
    ...
    expectedData.append(ByteArrayCommands::uint32ToByteArrayBig(sector));
    expectedData.append(ByteArrayCommands::uint32ToByteArrayBig(offset));
